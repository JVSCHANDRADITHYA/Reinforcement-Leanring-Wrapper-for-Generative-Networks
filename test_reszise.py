...
# # Parameters
# # ----------------------------
# image_path = r"input_images\bench.png"  # Path to the input image
# results_dir = './results/'               # Directory to save results
# model_name = 'desmoke'                    # Model name
# model_type = 'test'                       # Model type
# no_dropout = True                         # No dropout flag
# max_side = 512                            # Resize so max dimension = this

# # ----------------------------
# # Helper to resize for inference
# # ----------------------------
# def resize_for_inference(img, max_side=512):
#     h, w = img.shape[:2]
...
#     resized_image, (orig_w, orig_h) = resize_for_inference(input_image, max_side)
...
#     # Get result & resize back to original
...
#     fused_path = os.path.join(results_dir, f'input_output_fused_{timestamp}.png')
#     cv2.imwrite(fused_path, fused_image)
#     print(f"Fused image saved to {fused_path}")

#     # Optional display (remove if headless)
